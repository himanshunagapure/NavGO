...
//        String s = String.valueOf(Html.fromHtml(getString(R.string.chem_lab)));//getResources().getString(R.string.chem_lab);
        ...
        spDestination.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (currentPos!=null && destinationPos!=null) {
                    ...
                    Toast.makeText(MainActivity2.this, "Select Destination", Toast.LENGTH_SHORT).show();
                }
...
//            public void run() {
//                int scrollTo = 0;
//                final int count = ((RelativeLayout) scrollView.getChildAt(0)).getChildCount();
//
//                for (int i = 0; i < count; i++) {
//                    final View child = ((RelativeLayout) scrollView.getChildAt(0)).getChildAt(i);
//                    if(child.getTag().equals(qrID)){
