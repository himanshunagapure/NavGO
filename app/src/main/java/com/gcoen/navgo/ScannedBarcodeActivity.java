...
//                        startActivity(new Intent(ScannedBarcodeActivity.this, MainActivity.class).putExtra("current_location", intentData));
                    ...
                    Toast.makeText(ScannedBarcodeActivity.this, "Location not detected.Scan again", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        barcodeDetector.setProcessor(new Detector.Processor<Barcode>() {
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                if (barcodes.size() != 0) {
                    ...
                    Log.d(TAG, "receiveDetections:R "+barcodes.valueAt(0).rawValue);
                    Log.d(TAG, "receiveDetections:D "+barcodes.valueAt(0).displayValue);
                    Log.d(TAG, "receiveDetections:E "+barcodes.valueAt(0).email);
